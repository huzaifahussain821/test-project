...
class DoctorSignUpPersonalInformation extends StatefulWidget {
  const DoctorSignUpPersonalInformation({Key? key}) : super(key: key);

  @override
  State<DoctorSignUpPersonalInformation> createState() =>
      _DoctorSignUpPersonalInformationState();
}

class _DoctorSignUpPersonalInformationState
    extends State<DoctorSignUpPersonalInformation> {
