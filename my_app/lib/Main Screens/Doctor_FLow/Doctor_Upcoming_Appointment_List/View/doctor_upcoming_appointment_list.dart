...
class DoctorUpcomingAppointmentList extends StatefulWidget {
  const DoctorUpcomingAppointmentList({Key? key}) : super(key: key);

  @override
  State<DoctorUpcomingAppointmentList> createState() =>
      _DoctorUpcomingAppointmentListState();
}

class _DoctorUpcomingAppointmentListState
    extends State<DoctorUpcomingAppointmentList> {
    ...
    return InkWell(
      onTap: () {
        AppNavigation.navigateTo(
            context, AppRouteName.DOCTOR_UPCOMING_APPOINTMENT_DETAIL_SCREEN_ROUTE);
      },
      child: Container(
