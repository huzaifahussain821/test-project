...
class PatientPSCTest extends StatefulWidget {
  const PatientPSCTest({Key? key}) : super(key: key);

  @override
  State<PatientPSCTest> createState() => _PatientPSCTestState();
}

class _PatientPSCTestState extends State<PatientPSCTest> {
  int _groupValue = -1;
  ...
  Widget consultQuestionButton() {
    return CustomButtonWidget(
      containerWidth: AppSize.widthSize * 0.3,
      containerheight: AppSize.heightSize * 0.07,
      buttonText: "Consult",
      textColor: AppColors.WHITE_PURE_COLOR,
      fontSize: 1.1.sp,
      ...
      onTap: () {
        ...
        AppNavigation.navigateReplacementNamed(
            context, AppRouteName.PATIENT_SCHEDULE_APPOINTMENT_SCREEN_ROUTE);
      },
    );
  }
