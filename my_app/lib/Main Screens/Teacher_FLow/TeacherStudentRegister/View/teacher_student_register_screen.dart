...
class TeacherStudentRegistration extends StatefulWidget {
  const TeacherStudentRegistration({Key? key}) : super(key: key);

  @override
  State<TeacherStudentRegistration> createState() =>
      _TeacherStudentRegistrationState();
}

class _TeacherStudentRegistrationState
    extends State<TeacherStudentRegistration> {
  ...
  Widget _studentidTextFormWidget() {
    return CustomTextFormFieldWidget(
      controller: _studentIdController,

      textKeyboardType: TextInputType.emailAddress,
      prefixImagePath: AssetPaths.STUDENTID_ICON,
      containerWidth: AppSize.widthSize * 0.86,
      containerHeight: AppSize.heightSize * 0.09,
    ...
    return CustomButtonWidget(
      ...
      onTap: () {
        ...
        AppNavigation.navigateTo(
            context, AppRouteName.TEACHER_ON_BOARDING_SCREEN_ROUTE);
      },
    );
  }
